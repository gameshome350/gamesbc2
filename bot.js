...
client.user.setGame(`=bc |Coded by ahmed`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "invite")) {
        let invite = new Discord.RichEmbed()
            ...
            .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=561916935881752591&permissions=8&scope=bot`);
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/GucdjS
            **`);
